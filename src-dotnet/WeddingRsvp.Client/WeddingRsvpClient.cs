...
public class WeddingRsvpClient : IRsvpClient, IInformationClient, INotificationClient, ISettingsClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            Logger.LogError(e, "A timeout error occurred while getting rsvp {Id}.", id);
            return ClientResponse<RsvpGuest, ClientFailResponse>.CreateFail(new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
        {
    ...
    public async Task<ClientResponse<IEnumerable<RsvpGuest>, ClientFailResponse>> GetAllRsvpsAsync(
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (!responseMessage.IsSuccessStatusCode)
                return ClientResponse<IEnumerable<RsvpGuest>, ClientFailResponse>.CreateFail(
                    new(responseMessage.StatusCode));
        ...
        {
            Logger.LogError(e, "An timeout error occurred while getting information in all languages");
            return ClientResponse<IEnumerable<RsvpGuest>, ClientFailResponse>.CreateFail(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            Logger.LogError(e, "The request for updating rsvp {Id} timed out.", rsvp.Id);
            return ClientResponse<RsvpGuest, ClientFailResponse>.CreateFail(new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
        {
    ...
    public async Task<ClientResponse<RsvpGuest, ClientFailResponse>> AddRsvpAsync(RsvpGuest rsvp,
        CancellationToken cancellationToken = default)
    {
        using var client = HttpClientFactory.CreateClient(RsvpAdminClientName);
        ...
        {
            Logger.LogError(e, "The request for creating rsvp {Id} timed out.", rsvp.Id);
            return ClientResponse<RsvpGuest, ClientFailResponse>.CreateFail(new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
        {
    ...
    public async Task<ClientResponse<ClientFailResponse>> DeleteRsvpAsync(Guid id,
        CancellationToken cancellationToken = default)
    {
        using var client = HttpClientFactory.CreateClient(RsvpAdminClientName);
        ...
        {
            Logger.LogError(e, "A timeout error occurred while deleting rsvp {Id}.", id);
            return ClientResponse<ClientFailResponse>.CreateFail(new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
        {
    ...
    public async Task<ClientResponse<IEnumerable<DynamicInformation>, ClientFailResponse>>
        GetInformationInAllLanguagesAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (!responseMessage.IsSuccessStatusCode)
                return ClientResponse<IEnumerable<DynamicInformation>, ClientFailResponse>.CreateFail(
                    new(responseMessage.StatusCode));

            var dto = await responseMessage.Content
                .ReadFromJsonAsync<IEnumerable<GetInformationDto>>(cancellationToken);
            ...
            return ClientResponse<IEnumerable<DynamicInformation>, ClientFailResponse>
                .CreateSuccess(dynamicInformation);
        }
        catch (HttpRequestException e)
        {
            Logger.LogError(e, "Network error or server is unreachable while getting information in all languages.");
        ...
        {
            Logger.LogError(e, "A timeout error occurred while getting information in all languages.");
            return ClientResponse<IEnumerable<DynamicInformation>, ClientFailResponse>.CreateFail(
                new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
    ...
    public async Task<ClientResponse<DynamicInformation, ClientFailResponse>> GetInformationAsync(string language,
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var responseMessage =
                await client.GetAsync($"language/{language}", cancellationToken).ConfigureAwait(false);

            if (!responseMessage.IsSuccessStatusCode)
                return ClientResponse<DynamicInformation, ClientFailResponse>.CreateFail(
                    new(responseMessage.StatusCode));
    ...
    public async Task<ClientResponse<DynamicInformation, ClientFailResponse>> UpdateInformationAsync(
        DynamicInformation information, CancellationToken cancellationToken = default)
    {
        using var client = HttpClientFactory.CreateClient(InformationAdminClientName);
        ...
        try
        {
            var responseMessage = await client
                .PutAsJsonAsync($"{information.Id}", information.ToPutDto(), cancellationToken).ConfigureAwait(false);
        ...
        {
            Logger.LogError(e, "Network error or server is unreachable while updating information {Language}.",
                information.Language);
        }
        catch (OperationCanceledException e)
        {
            Logger.LogInformation(e, "The request updating information in {Language} timed out or was cancelled.",
                information.Language);
        }
        catch (TimeoutRejectedException e)
        {
            Logger.LogError(e, "A timeout error occurred while updating information in {Language}.",
                information.Language);
            return ClientResponse<DynamicInformation, ClientFailResponse>.CreateFail(
                new(HttpStatusCode.ServiceUnavailable));
        }
        ...
        {
            Logger.LogError(e, "An unexpected error occurred while updating information in {Language}.",
                information.Language);
        }
    ...
    public async Task<ClientResponse<DynamicInformation, ClientFailResponse>> AddInformationAsync(
        DynamicInformation information, CancellationToken cancellationToken = default)
    {
        using var client = HttpClientFactory.CreateClient(InformationAdminClientName);
        ...
        try
        {
            var responseMessage = await client.PostAsJsonAsync("", information.ToPostDto(), cancellationToken)
                .ConfigureAwait(false);
        ...
        {
            Logger.LogError(e, "Network error or server is unreachable while creating information in {Language}.",
                information.Language);
        }
        catch (OperationCanceledException e)
        {
            Logger.LogInformation(e, "The request creating information in {Language} timed out or was cancelled.",
                information.Language);
        }
        catch (TimeoutRejectedException e)
        {
            Logger.LogError(e, "A timeout error occurred while creating information in {Language}.",
                information.Language);
            return ClientResponse<DynamicInformation, ClientFailResponse>.CreateFail(
                new(HttpStatusCode.ServiceUnavailable));
        }
        ...
        {
            Logger.LogError(e, "An unexpected error occurred while creating information {Language}.",
                information.Language);
        }
    ...
    public async Task<ClientResponse<ClientFailResponse>> SendNotificationAsync(RsvpGuest rsvp,
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var responseMessage = await client.PostAsJsonAsync("", rsvp.ToPostNotificationDto(), cancellationToken)
                .ConfigureAwait(false);

            if (!responseMessage.IsSuccessStatusCode)
            {
                Logger.LogWarning("Cannot send email for {RsvpId} with status code {StatusCode}.", rsvp.Id,
        ...
        {
            Logger.LogError(e,
                "Network error or server is unreachable while triggering email notification for {RsvpId}.", rsvp.Id);
        }
        catch (OperationCanceledException e)
        {
            Logger.LogInformation(e,
                "The request triggering email notification for {RsvpId} timed out or was cancelled.", rsvp.Id);
        }
        catch (TimeoutRejectedException e)
        {
            Logger.LogError(e, "The request triggering email notification for {RsvpId} timed out.", rsvp.Id);
            return ClientResponse<ClientFailResponse>.CreateFail(new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
        {
            Logger.LogError(e, "An unexpected error occurred while triggering email notification for {RsvpId}.",
                rsvp.Id);
        }
    ...
    public async Task<ClientResponse<ApplicationSettings, ClientFailResponse>> GetSettingsAsync(
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (!responseMessage.IsSuccessStatusCode)
                return ClientResponse<ApplicationSettings, ClientFailResponse>.CreateFail(
                    new(responseMessage.StatusCode));
        ...
        {
            Logger.LogError(e, "The request getting settings timed out.");
            return ClientResponse<ApplicationSettings, ClientFailResponse>.CreateFail(
                new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
    ...
    public async Task<ClientResponse<ApplicationSettings, ClientFailResponse>> UpdateSettingsAsync(
        ApplicationSettings settings, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var responseMessage = await client.PutAsJsonAsync("", settings.ToPutDto(), cancellationToken)
                .ConfigureAwait(false);
        ...
        {
            Logger.LogError(e, "The request updating settings timed out.");
            return ClientResponse<ApplicationSettings, ClientFailResponse>.CreateFail(
                new(HttpStatusCode.ServiceUnavailable));
        }
        catch (Exception e)
